...
## LEDs
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports {LED_xy00}]
...
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {scl_s}];#Sch name = JA1
 set_property -dict { PACKAGE_PIN L2  IOSTANDARD LVCMOS33 } [get_ports {sda_s}];#Sch name = JA2
...
# set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 / [get_ports {scl_s}];#Sch name = JB1 bbbbbbbbbbbbbbb
...
# set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports {sda_s}];#Sch name = JB7 aaaaaaaaaaaaaaaa
...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports {miso[0]}];#Sch name = XA1_P
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports {miso[1]}];#Sch name = XA2_P
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {miso[2]}];#Sch name = XA3_P
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {miso[3]}];#Sch name = XA4_P
set_property -dict { PACKAGE_PIN K3   IOSTANDARD LVCMOS33 } [get_ports {miso[4]}];#Sch name = XA1_N
set_property -dict { PACKAGE_PIN M3   IOSTANDARD LVCMOS33 } [get_ports {sclk}];#Sch name = XA2_N
